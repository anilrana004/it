...
function CheckoutInner() {
  ...
  return (
    <div className="max-w-lg mx-auto text-center">
      <div className="w-16 h-16 bg-[#afde1e]/10 rounded-full flex items-center justify-center mx-auto mb-6"><Check className="w-8 h-8 text-[#afde1e]" /></div>
      <h1 className="font-[family-name:var(--font-heading)] text-2xl lg:text-3xl font-bold text-[#040921] mb-3">Booking Initiated!</h1>
      ...
      <div className="bg-gray-50 rounded-2xl p-6 text-left space-y-3 mb-8">
        ...
        <div className="flex justify-between text-sm"><span className="text-gray-500">Payable Now</span><span className="font-semibold text-[#afde1e]">₹{nowPay.toLocaleString()}</span></div>
      </div>
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        <a href="https://wa.me/919999999999" target="_blank" className="inline-flex items-center justify-center gap-2 bg-[#afde1e] hover:bg-[#8cb818] text-gray-900 font-semibold px-8 py-3.5 rounded-full transition-all">Pay via WhatsApp <ArrowRight className="w-4 h-4" /></a>
