    ...
    <div className="pt-20 lg:pt-28 pb-12 lg:pb-20">
      <div className="container mx-auto max-w-3xl px-4">
        ...
        <div className="text-gray-700 text-sm space-y-4">
          <p>By booking a trip with Indian Treks, you agree to the following terms and conditions.</p>
          ...
          <p>Indian Treks acts as an organizer and is not liable for any injuries, losses, or damages incurred during the trip. Participants join at their own risk.</p>
