...
export default function ReviewsPage() {
  return (
    <div className="pb-12 lg:pb-20 bg-[#f7f7f7]">
      <section className="bg-gradient-to-br from-[#14532d] via-[#166534] to-[#16a34a] py-10 lg:py-14 mb-8">
      ...
      <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col">
                ...
                <div className="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between gap-3">
                  ...
                  <Link
                    href={r.href}
                    className="text-xs font-semibold text-[#16a34a] hover:text-[#15803d] inline-flex items-center gap-1 shrink-0"
                  >
        ...
        <div className="text-center mt-10">
          <Link
            href="/treks"
            className="inline-flex items-center gap-2 bg-[#16a34a] hover:bg-[#15803d] text-white font-semibold px-7 py-3 rounded-full transition-all"
          >
