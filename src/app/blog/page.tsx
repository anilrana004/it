        ...
        <section className="relative h-[30vh] min-h-[220px] overflow-hidden mb-10">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/70 to-black/30 flex items-center">
            <div className="container mx-auto px-4">
              <h1 className="font-[family-name:var(--font-heading)] text-3xl lg:text-5xl font-bold text-white mb-2">Our Blog</h1>
            ...
            {blogs.map((b, i) => (
              <Link key={i} href={b.h} className="group bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-lg transition-all">
                ...
                <div className="p-5">
                  ...
                  <h3 className="font-semibold text-gray-900 leading-snug line-clamp-3 group-hover:text-[#16a34a] transition-colors">{b.t}</h3>
                </div>
              </Link>
            ))}
          </div>
