...
const blogPosts: Record<string, { title: string; content: string; date: string; read: string; author: string; image: string }> = {
  'first-himalayan-trek': {
    ...
    date: '30 Jul', read: '6 min read', author: 'Indian Treks Team', image: 'https://images.unsplash.com/photo-1551632811-561732d1e306?w=1200&h=600&fit=crop',
  },
  'group-travel-himalayas': {
    ...
    date: '25 Jun', read: '5 min read', author: 'Indian Treks Team', image: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=1200&h=600&fit=crop',
  },
  'valley-of-flowers-guide': {
    ...
    date: '16 May', read: '9 min read', author: 'Indian Treks Team', image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&h=600&fit=crop',
  },
  'best-places-india-july': {
    ...
    date: '16 Jun', read: '6 min read', author: 'Indian Treks Team', image: 'https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1200&h=600&fit=crop',
  },
};
