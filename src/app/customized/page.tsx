...
export default function CustomizedPage() {
  return (
    <div className="pt-24 lg:pt-28 pb-12 lg:pb-20">
      {/* Hero */}
      <section className="bg-gradient-to-r from-[#1a1a2e] to-[#16213e] py-10 lg:py-16 mb-10 lg:mb-16">
      ...
      <div className="container mx-auto">
        ...
        <div className="mb-12 lg:mb-20">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h2 className="font-[family-name:var(--font-heading)] text-2xl lg:text-3xl font-bold text-[#1a1a2e]">Customised Nepal Tour Packages</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6">
            {intlPkg.map(d => (
              <Link key={d.name} href={d.href} className="group bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-lg transition-all">
                ...
                <div className="p-4">
                  <h3 className="font-bold text-base lg:text-lg text-[#1a1a2e] group-hover:text-[#359DFC] transition-colors">{d.name}</h3>
                  <div className="flex items-center justify-between mt-1.5">
                    <span className="text-xs text-gray-500">{d.count}+ Packages</span>
                    <span className="text-[#EA5939] font-bold text-sm">₹{d.price.toLocaleString()}+</span>
                  </div>
                </div>
              </Link>
            ))}
        ...
        <div className="mb-12 lg:mb-20">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h2 className="font-[family-name:var(--font-heading)] text-2xl lg:text-3xl font-bold text-[#1a1a2e]">Customised India Tour Packages</h2>
        ...
        <div className="bg-gray-50 rounded-2xl p-6 lg:p-10 mb-12 lg:mb-20">
          <h2 className="font-[family-name:var(--font-heading)] text-xl lg:text-2xl font-bold text-[#1a1a2e] text-center mb-8">How Customised Tour Works</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={s.step} className="text-center">
                <div className="w-12 h-12 bg-[#359DFC] text-white rounded-full flex items-center justify-center font-bold text-lg mx-auto mb-3">{s.step}</div>
                <h3 className="font-bold text-sm lg:text-base text-[#1a1a2e] mb-1.5">{s.title}</h3>
        ...
        {/* CTA */}
        <div className="bg-gradient-to-r from-[#359DFC] to-[#1a7de0] rounded-2xl p-8 lg:p-12 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="tel:+919999999999" className="inline-flex items-center gap-2 bg-white text-[#359DFC] font-semibold px-8 py-3 rounded-full hover:bg-gray-100 transition-all text-sm">Call +91 99 99 99 99 99</a>
