...
const indiaPkg = [
  ...
  { name: 'Valley of Flowers', count: 6, img: photos.vof, price: 8999, href: '/treks/valley-of-flowers' },
      ...
      <div className="container mx-auto">
        ...
        <div className="mb-12 lg:mb-20">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h2 className="font-[family-name:var(--font-heading)] text-2xl lg:text-3xl font-bold text-[#000000]">Customised Nepal Tour Packages</h2>
        ...
        <div className="mb-12 lg:mb-20">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h2 className="font-[family-name:var(--font-heading)] text-2xl lg:text-3xl font-bold text-[#000000]">Customised India Tour Packages</h2>
        ...
        <div className="bg-gray-50 rounded-2xl p-6 lg:p-10 mb-12 lg:mb-20">
          <h2 className="font-[family-name:var(--font-heading)] text-xl lg:text-2xl font-bold text-[#000000] text-center mb-8">How Customised Tour Works</h2>
