...
export default function CorporatePage() {
  return (
    <div className="pt-24 lg:pt-28 pb-12 lg:pb-20">
      {/* Hero */}
      <section className="bg-gradient-to-r from-[#040921] to-[#040921] py-12 lg:py-20 mb-10 lg:mb-16">
        <div className="container mx-auto text-center">
          <Building2 className="w-10 h-10 lg:w-14 lg:h-14 text-[#afde1e] mx-auto mb-4" />
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <a href="tel:+919999999999" className="inline-flex items-center gap-2 bg-[#afde1e] hover:bg-[#8cb818] text-gray-900 font-semibold px-6 py-3 rounded-full transition-all text-sm">Call Us Now</a>
      ...
      <div className="container mx-auto">
        ...
        <div className="mb-12 lg:mb-20">
          <div className="text-center mb-8">
            <h2 className="font-[family-name:var(--font-heading)] text-2xl lg:text-3xl font-bold text-[#040921] mb-2">Our Corporate Offerings</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6">
            {[
              ...
              <div key={s.title} className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-all text-center">
                ...
                <h3 className="font-bold text-base lg:text-lg text-[#040921] mb-2">{s.title}</h3>
        ...
        <div className="bg-gray-50 rounded-2xl p-6 lg:p-10 mb-12 lg:mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <h2 className="font-[family-name:var(--font-heading)] text-2xl lg:text-3xl font-bold text-[#040921] mb-4">Why Choose TrekRoot for Corporate?</h2>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-12 lg:mb-20">
          {[
            ...
            <div key={s.l} className="bg-gradient-to-br from-[#afde1e]/10 to-[#afde1e]/5 rounded-xl p-5 text-center border border-[#afde1e]/20">
              <div className="font-bold text-xl lg:text-3xl text-[#afde1e]">{s.v}</div>
        ...
        {/* Testimonial */}
        <div className="bg-gradient-to-r from-[#afde1e] to-[#8cb818] rounded-2xl p-6 lg:p-10 text-white mb-12 lg:mb-20">
        ...
        <div className="text-center">
          <h2 className="font-[family-name:var(--font-heading)] text-2xl lg:text-3xl font-bold text-[#040921] mb-2">Ready to Plan Your Corporate Adventure?</h2>
          <p className="text-gray-500 text-sm mb-6">Get a free quote for your team&apos;s next offsite or retreat.</p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="tel:+919999999999" className="inline-flex items-center gap-2 bg-[#afde1e] text-gray-900 font-semibold px-8 py-3 rounded-full hover:bg-[#8cb818] transition-all text-sm">Call +91 99 99 99 99 99</a>
