    ...
    <div className="pt-20 lg:pt-28 pb-12 lg:pb-20">
      <section className="relative h-[35vh] min-h-[220px] overflow-hidden mb-8">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 to-black/30 flex items-center">
          <div className="container mx-auto px-4"><h1 className="font-[family-name:var(--font-heading)] text-3xl lg:text-5xl font-bold text-white mb-2">Career With TrekRoot</h1><p className="text-gray-200 text-lg">Where Adventure Meets Opportunity</p></div>
        </div>
      </section>
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <h2 className="font-[family-name:var(--font-heading)] text-2xl font-bold text-[#1a1a2e] text-center mb-6">Current Openings</h2>
        <div className="space-y-3">
          {['Operations Executive', 'Freelance Trip Lead', 'Corporate Sales', 'Full Stack Developer', 'Talent & Culture Manager'].map(job => (
            <div key={job} className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 flex items-center justify-between">
              ...
              <button className="bg-[#359DFC] text-white text-xs font-semibold px-5 py-2 rounded-full hover:bg-[#1a7de0] transition-all">Apply Now</button>
            </div>
          ))}
        </div>
      </div>
