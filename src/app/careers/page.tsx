        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 to-black/30 flex items-center">
          <div className="container mx-auto px-4">
            <h1 className="font-[family-name:var(--font-heading)] text-3xl lg:text-5xl font-bold text-white mb-2">
              Career With Indian Treks
            </h1>
            <p className="text-gray-200 text-lg">Where Adventure Meets Opportunity</p>
          </div>
        </div>
      </section>
      <div className="container mx-auto max-w-4xl px-4">
        <div className="text-center mb-10">
          <p className="text-gray-600 text-sm lg:text-base max-w-2xl mx-auto">
            We are a vibrant Social Travel Community that brings like-minded explorers together
            through meticulously organized trips and fixed departures. If you&apos;re eager to make a
            difference in the travel industry and help others create unforgettable memories,
        ...
        <h2 className="font-[family-name:var(--font-heading)] text-2xl font-bold text-[#000000] text-center mb-6">
          Current Openings
        </h2>
        <div className="space-y-3">
          {[
            ...
            >
              ...
              <button
                type="button"
                className="bg-[#16a34a] text-white text-xs font-semibold px-5 py-2 rounded-full hover:bg-[#15803d] transition-all"
              >
                Apply Now
              </button>
            </div>
