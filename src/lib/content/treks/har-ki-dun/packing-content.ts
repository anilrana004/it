...
/** Things to carry — Har Ki Dun trek packing list. */
export const HAR_KI_DUN_PACKING_SECTION: TrekRichSection = {
  id: 'things-to-carry',
  kicker: 'Packing Guide',
  title: 'Things to Carry',
  intro:
    'Participants must bring the following for the Har Ki Dun Trek. Pack light but complete — aim for a well-fitted 50–60 L backpack and break in your boots before departure.',
  blocks: [
    {
      type: 'h3',
      text: 'Participants must bring for Har Ki Dun Trek',
    },
    {
      type: 'ul',
      items: [
