import type { RichBlock } from '@/lib/content/treks/types';

/**
 * Expanded overview — shown under “Read More” on the Kuari Pass trek detail page.
 * Video: https://youtu.be/rmuuxRaCSH0
 */
