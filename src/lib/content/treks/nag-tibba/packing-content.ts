...
/** Things to carry — Nag Tibba trek packing list. */
export const NAG_TIBBA_PACKING_SECTION: TrekRichSection = {
  id: 'things-to-carry',
  kicker: 'Packing Guide',
  title: 'Things to Carry',
  intro:
    'Participants must bring the following for the Nag Tibba Trek. Pack light but complete — aim for a well-fitted 50–60 L backpack and break in your boots before departure.',
  blocks: [
    {
      type: 'h3',
      text: 'Participants must bring for Nag Tibba Trek',
    },
    {
      type: 'ul',
      items: [
        '50–60 L backpack',
        'Strong hiking boots — a leather upper is best because it gives your ankles more support. If you don’t have a pair yet, get one as soon as possible and wear it a lot so it breaks in well. This helps keep blisters from forming.',
