...
/** How to reach Nag Tibba — gateway city directions (Dehradun). */
export const NAG_TIBBA_REACH_STEPS: TrekReachStep[] = [
  {
    title: 'Directions to go to Dehradun',
    items: [
      {
        label: 'By Air',
      ...
      {
        label: 'By Train',
        text: 'The Dehradun Junction is the closest railway station, and it has excellent connections to major cities located around India.',
      },
      {
        label: 'By Road',
