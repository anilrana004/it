...
const TREK_LINK_RULES: { pattern: RegExp; label: string; href: string }[] = [
  ...
  { pattern: /triund|mcleodganj/i, label: 'Triund Trek', href: '/treks/triund' },
  ...
  { pattern: /char dham/i, label: 'Char Dham Yatra', href: '/yatra/char-dham-yatra' },
  { pattern: /spiti/i, label: 'Spiti Backpacking', href: '/backpacking/spiti' },
  { pattern: /meghalaya/i, label: 'Meghalaya Backpacking', href: '/backpacking/meghalaya' },
  { pattern: /himachal backpacking/i, label: 'Himachal Backpacking', href: '/backpacking/himachal' },
  { pattern: /uttarakhand backpacking/i, label: 'Uttarakhand Backpacking', href: '/backpacking/uttarakhand' },
  { pattern: /backpacking/i, label: 'Backpacking Trips', href: '/backpacking' },
  { pattern: /ladakh|leh/i, label: 'Ladakh Biking', href: '/biking/ladakh' },
  { pattern: /manali|spiti.*bik/i, label: 'Himalayan Biking', href: '/biking' },
  { pattern: /bali/i, label: 'Bali Getaway', href: '/international/bali' },
  { pattern: /bhutan/i, label: 'Bhutan Getaway', href: '/international/bhutan' },
  ...
  { pattern: /senior/i, label: 'Senior Citizen Treks', href: '/special-programs/senior-citizen-treks' },
