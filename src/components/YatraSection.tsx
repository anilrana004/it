          ...
          {yatras.map(t => (
            <Link key={t.id} href={`/yatra/${t.id}`} className="group block bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <div className="p-4 lg:p-5">
                <h3 className="font-bold text-sm lg:text-base text-gray-900 leading-snug line-clamp-2 group-hover:text-[#ffaf21] transition-colors mb-2">{t.title}</h3>
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs font-medium text-[#ffaf21] bg-[#ffaf21]/5 px-2 py-0.5 rounded-full">{t.bestSeason}</span>
                </div>
