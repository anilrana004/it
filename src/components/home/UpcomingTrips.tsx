...
const trips = [
  ...
  { date: '12-16 Sep 2026', origin: 'Dehradun', dest: 'Kedarkantha', title: 'Kedarkantha Trek', dur: '5D/4N', price: 6999, origPrice: 8999, rating: '4.9', reviews: '10k+', badge: '', img: 'https://res.cloudinary.com/pg8uhzw0/image/fetch/f_auto,q_auto,w_420,h_280,c_fill,g_auto/', href: '/treks/kedarkantha', type: 'domestic' },
  { date: '18-22 Sep 2026', origin: 'Manali', dest: 'Hampta Pass', title: 'Hampta Pass Trek', dur: '5D/4N', price: 8499, origPrice: 10999, rating: '4.7', reviews: '8k+', badge: '', img: 'https://res.cloudinary.com/pg8uhzw0/image/fetch/f_auto,q_auto,w_420,h_280,c_fill,g_auto/', href: '/treks/hampta-pass', type: 'domestic' },
  { date: '20-24 Sep 2026', origin: 'Rishikesh', dest: 'Chopta', title: 'Chopta Tungnath Trek', dur: '4D/3N', price: 5999, origPrice: 7999, rating: '4.7', reviews: '6k+', badge: 'Trending', img: 'https://res.cloudinary.com/pg8uhzw0/image/fetch/f_auto,q_auto,w_420,h_280,c_fill,g_auto/', href: '/treks/chopta-tungnath', type: 'domestic' },
  { date: '25-30 Sep 2026', origin: 'Pokhara', dest: 'ABC', title: 'Annapurna Base Camp Trek', dur: '8D/7N', price: 34999, origPrice: 42999, rating: '4.9', reviews: '15k+', badge: '', img: 'https://res.cloudinary.com/pg8uhzw0/image/fetch/f_auto,q_auto,w_420,h_280,c_fill,g_auto/', href: '/treks/annapurna-base-camp', type: 'international' },
  { date: '3-8 Oct 2026', origin: 'Rishikesh', dest: 'Kedarnath', title: 'Kedarnath Yatra', dur: '6D/5N', price: 9999, origPrice: 12999, rating: '4.8', reviews: '12k+', badge: 'Popular', img: 'https://res.cloudinary.com/pg8uhzw0/image/fetch/f_auto,q_auto,w_420,h_280,c_fill,g_auto/', href: '/yatra/kedarnath-yatra', type: 'domestic' },
  { date: '10-15 Oct 2026', origin: 'Manali', dest: 'Triund', title: 'Triund Trek', dur: '3D/2N', price: 2499, origPrice: 3999, rating: '4.6', reviews: '15k+', badge: 'Weekend', img: 'https://res.cloudinary.com/pg8uhzw0/image/fetch/f_auto,q_auto,w_420,h_280,c_fill,g_auto/', href: '/treks/mcleodganj-trek', type: 'domestic' },
  { date: '5-17 Oct 2026', origin: 'Kathmandu', dest: 'EBC', title: 'Everest Base Camp Trek', dur: '13D/12N', price: 74999, origPrice: 89999, rating: '4.9', reviews: '20k+', badge: '', img: 'https://res.cloudinary.com/pg8uhzw0/image/fetch/f_auto,q_auto,w_420,h_280,c_fill,g_auto/', href: '/treks/everest-base-camp', type: 'international' },
  { date: '25-30 Oct 2026', origin: 'Rishikesh', dest: 'Rishikesh', title: 'Do Dham Yatra (Kedarnath+Badrinath)', dur: '7D/6N', price: 14999, origPrice: 18999, rating: '4.8', reviews: '8k+', badge: 'Yatra', img: 'https://res.cloudinary.com/pg8uhzw0/image/fetch/f_auto,q_auto,w_420,h_280,c_fill,g_auto/', href: '/yatra/do-dham', type: 'domestic' },
  { date: '5-14 Nov 2026', origin: 'Kathmandu', dest: 'Nepal', title: 'Nepal Backpacking Circuit', dur: '10D/9N', price: 34999, origPrice: 42999, rating: '4.8', reviews: '6k+', badge: 'Popular', img: 'https://res.cloudinary.com/pg8uhzw0/image/fetch/f_auto,q_auto,w_420,h_280,c_fill,g_auto/', href: '/treks/nepal-backpacking', type: 'international' },
];
