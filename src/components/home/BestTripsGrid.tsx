    ...
    <section className="py-8 lg:py-16 bg-gray-50">
      <div className="container mx-auto">
        <div className="text-center mb-6 lg:mb-8">
          <p className="text-[#ffaf21] font-semibold text-xs lg:text-sm tracking-widest uppercase mb-1">BEST TRIPS</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
          {trips.map(t => (
            <Link key={t.title} href={t.href} className="group relative rounded-xl overflow-hidden h-52 lg:h-64">
              ...
              {t.badge && <span className="absolute top-3 left-3 bg-[#ffaf21] text-gray-900 text-[10px] lg:text-xs font-bold px-2.5 py-1 rounded-full">{t.badge}</span>}
