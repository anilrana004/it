...
const data: Record<string, { title: string; loc: string; dur: string; price: number; origPrice: number; rating: string; rev: string; img: string; href: string; badge?: string }[]> = {
  'International': [
    ...
    { title: 'Bhutan Bike and Backpacking | 8 Days Bhutan Bike Tour', loc: 'Bagdogra to Bagdogra', dur: '7N/8D', price: 45000, origPrice: 0, rating: '4.8', rev: '10k+', img: 'https://images.unsplash.com/photo-1540979388789-6cee28a1cdc9?w=420&h=280&fit=crop', href: '/treks' },
    { title: 'Bali with Gili Island Group Tour - Ubud, Nusa Penida & Kuta (7N/8D)', loc: 'Bali Airport to Bali Airport', dur: '7N/8D', price: 53500, origPrice: 57000, rating: '4.8', rev: '10k+', img: 'https://images.unsplash.com/photo-1539367628448-4bc5c9d171c8?w=420&h=280&fit=crop', href: '/treks' },
    { title: 'Bhutan Tour with Phobjikha Valley - 8 Days', loc: 'Bagdogra to Siliguri', dur: '7N/8D', price: 45000, origPrice: 0, rating: '4.8', rev: '10k+', img: 'https://images.unsplash.com/photo-1543429257-3eb0b65d9c10?w=420&h=280&fit=crop', href: '/treks' },
  ],
  'Ladakh Zanskar': [
    { title: 'Zanskar Valley Backpacking Trip | 8 Days Delhi to Delhi Tour', loc: 'Delhi to Delhi', dur: '7N/8D', price: 25000, origPrice: 28000, rating: '4.8', rev: '10k+', img: 'https://images.unsplash.com/photo-1486911278844-a81c5267e227?w=420&h=280&fit=crop', href: '/treks/bali-pass' },
    { title: 'Leh Ladakh Bike Trip From Srinagar with Hanle & Umling La', loc: 'Srinagar to Leh', dur: '11N/12D', price: 45000, origPrice: 0, rating: '4.9', rev: '10k+', img: 'https://images.unsplash.com/photo-1486911278844-a81c5267e227?w=420&h=280&fit=crop', href: '/treks/everest-base-camp' },
    { title: 'Zanskar Valley Expedition', loc: 'Leh to Leh', dur: '8N/9D', price: 32000, origPrice: 0, rating: '4.8', rev: '8k+', img: 'https://images.unsplash.com/photo-1540979388789-6cee28a1cdc9?w=420&h=280&fit=crop', href: '/treks/bali-pass' },
  ],
  'Spiti Valley': [
    { title: 'Spiti Valley Bike and Backpacking Trip', loc: 'Delhi to Delhi', dur: '9N/10D', price: 25000, origPrice: 0, rating: '4.8', rev: '8k+', img: 'https://images.unsplash.com/photo-1586350977770-2598f1b6b7c8?w=420&h=280&fit=crop', href: '/treks/hampta-pass' },
    { title: 'Road Trip to Spiti Valley', loc: 'Delhi to Delhi', dur: '8N/9D', price: 22000, origPrice: 0, rating: '4.8', rev: '8k+', img: 'https://images.unsplash.com/photo-1586350977770-2598f1b6b7c8?w=420&h=280&fit=crop', href: '/treks/hampta-pass' },
    { title: 'All Girls Road Trip to Spiti Valley', loc: 'Delhi to Delhi', dur: '8N/9D', price: 24000, origPrice: 0, rating: '4.8', rev: '6k+', img: 'https://images.unsplash.com/photo-1529333166437-7750a6dd5a70?w=420&h=280&fit=crop', href: '/treks/hampta-pass' },
  ],
};
