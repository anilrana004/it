        ...
        <div className="flex gap-2 overflow-x-auto pb-3 pt-1 scrollbar-none" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          {filters.map(f => (
            <Link key={f.label} href={f.href}
              className="flex items-center gap-1.5 shrink-0 px-4 py-2 rounded-lg bg-gray-50 hover:bg-[#ffaf21] hover:text-black border border-gray-100 hover:border-[#ffaf21] text-xs font-semibold text-gray-700 transition-all">
