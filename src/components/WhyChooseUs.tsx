    ...
    <section className="py-8 lg:py-16 bg-white">
      <div className="container mx-auto">
        <div className="text-center mb-8 lg:mb-10">
          <p className="text-[#ffaf21] font-semibold text-xs lg:text-sm tracking-widest uppercase mb-1">WHY CHOOSE US</p>
          <h2 className="text-xl lg:text-3xl font-bold text-[#000000] mb-3">Why Choose TrekRoot?</h2>
        ...
        <div className="bg-gradient-to-r from-[#000000] to-[#000000] rounded-2xl p-6 lg:p-10 text-white flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 lg:gap-10">
            <div className="text-center">
              <Users className="w-8 h-8 lg:w-10 lg:h-10 text-[#ffaf21] mx-auto mb-1" />
            ...
            <div className="text-center">
              <Award className="w-8 h-8 lg:w-10 lg:h-10 text-[#ffaf21] mx-auto mb-1" />
            ...
            <div className="text-center">
              <Heart className="w-8 h-8 lg:w-10 lg:h-10 text-[#ffaf21] mx-auto mb-1" />
