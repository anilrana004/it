    ...
    <section className="py-8 lg:py-16 bg-white">
      <div className="container mx-auto">
        <div className="text-center mb-8 lg:mb-10">
          <p className="text-[#359DFC] font-semibold text-xs lg:text-sm tracking-widest uppercase mb-1">WHY CHOOSE US</p>
          <h2 className="text-xl lg:text-3xl font-bold text-[#1a1a2e] mb-3">Why Choose TrekRoot?</h2>
          ...
          {features.map(f => (
            <div key={f.title} className="bg-gray-50 rounded-2xl overflow-hidden hover:shadow-lg transition-all">
              ...
              <div className="p-3 lg:p-5">
                <h3 className="font-bold text-xs lg:text-base text-[#1a1a2e] mb-1">{f.title}</h3>
        ...
        <div className="bg-gradient-to-r from-[#1a1a2e] to-[#16213e] rounded-2xl p-6 lg:p-10 text-white flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 lg:gap-10">
            <div className="text-center">
              <Users className="w-8 h-8 lg:w-10 lg:h-10 text-[#359DFC] mx-auto mb-1" />
            ...
            <div className="text-center">
              <Award className="w-8 h-8 lg:w-10 lg:h-10 text-[#359DFC] mx-auto mb-1" />
            ...
            <div className="text-center">
              <Heart className="w-8 h-8 lg:w-10 lg:h-10 text-[#359DFC] mx-auto mb-1" />
