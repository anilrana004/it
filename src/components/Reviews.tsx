...
const reviews = [
  { name: 'Ankita Choudhary', avatar: 'https://lh3.googleusercontent.com/a/ACg8ocLm8pipAwjeBKv1ut2rnRx-unDhbdaXRVZvJLGR-jdys5moZw=s120-c-rp-mo-br100', text: 'I recently joined the Bali community trip organized by Indian Treks. This was my first solo trip, and not once did I feel like I was traveling alone. The group was amazing, and a special thanks to Nishant for ensuring everyone had a fantastic time.', trip: 'Bali with Gili Island Group Tour', tripImg: 'https://res.cloudinary.com/pg8uhzw0/image/fetch/f_auto,q_auto,w_420,h_280,c_fill,g_auto/', tripHref: '/treks' },
  { name: 'Deepak Bansal', avatar: 'https://lh3.googleusercontent.com/a/ACg8ocLOlBP7lkiIOZ8IMeMbiVYc1t1fnGr6Y3GJXTzjWu9QnV68uQ=s64-c-rp-mo-br100', text: 'Excellent service, I had Spiti bike trip with Indian Treks on 6th June 2026. They provided a very nice bike and no doubt best service I ever had. I got sick between the trip but the way they handled it was just great.', trip: 'Spiti Valley Bike and Backpacking Trip', tripImg: 'https://res.cloudinary.com/pg8uhzw0/image/fetch/f_auto,q_auto,w_420,h_280,c_fill,g_auto/', tripHref: '/treks' },
  { name: 'Shivanand Pujari', avatar: 'https://lh3.googleusercontent.com/a/ACg8ocJFNs8uv9JSKBoUmiIh0ADF8rokVBkICM2cc2yVxqdgQSF9rw=s64-c-rp-mo-br100', text: 'Had been there for the Bhutan Bike & Backpacking trip from 14th to 21st March 2026. Had an amazing riding experience. Our trip leaders Prajwal and Abhishek were very supportive.', trip: 'Bhutan Bike and Backpacking', tripImg: 'https://res.cloudinary.com/pg8uhzw0/image/fetch/f_auto,q_auto,w_420,h_280,c_fill,g_auto/', tripHref: '/treks' },
];
        ...
        <div className="bg-white rounded-2xl p-5 lg:p-8 shadow-sm border border-gray-100">
          <div className="flex flex-col lg:flex-row gap-5 lg:gap-10">
            <div className="lg:w-1/2">
              ...
              <a href="#" className="inline-flex items-center gap-1 text-xs lg:text-sm text-[#16a34a] hover:text-[#15803d] font-medium">
                Read more
              </a>
            </div>
            <div className="lg:w-1/2">
